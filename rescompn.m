function [res] = rescompn(hi, Gi, hri, hmi, Gmi, hrmi, hpi, Gpi, hrpi, ri, hipre, Gipre, hripre, hmmmmi, hmmmi, hmmi, equ)
%%%
...
%%%
%%% Film thickness
  hder3 = (1.0*hmmmi-6.0*hmmi+12.0*hmi-10.0*hi+3.0*hpi)/(2.0*dr^3); 
  hder4 = (-1.0*hmmmmi+6.0*hmmmi-14.0*hmmi+16.0*hmi-9.0*hi+2.0*hpi)/(dr^4); 
%%% Film thickness
